...
public class LikingUsersRequest implements Request {
    ...
    public static final class LikingUsersRequestBuilder {
        ...
        public LikingUsersRequestBuilder mediaFields(MediaField[] mediaFields) {
            this.mediaFields = mediaFields;
            return this;
        }

        public LikingUsersRequestBuilder placeFields(PlaceField[] placeFields) {
            this.placeFields = placeFields;
            return this;
        }

        public LikingUsersRequestBuilder pollFields(PollField[] pollFields) {
        ...
        public LikingUsersRequest build() {
            ...
            likingUsersRequest.mediaFields = this.mediaFields;
            likingUsersRequest.pollFields = this.pollFields;
            likingUsersRequest.placeFields = this.placeFields;
